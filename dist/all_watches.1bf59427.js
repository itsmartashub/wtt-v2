...
},{}],"scripts/classes/UI.js":[function(require,module,exports) {
"use strict";
...
var $navbarFav = document.querySelector('.navbar__favs');
var $fav = document.querySelector('.fav');
var $closeFavBtn = document.querySelector('.fav .btn-close');
...
var UI = /*#__PURE__*/function () {
  ...
  _createClass(UI, [{
    key: "addClickListenersToNavbarIcons",
    value: function addClickListenersToNavbarIcons(_clickElOpen, _clickElClose, _el, _class) {
      _clickElOpen.addEventListener('click', function () {
        UI.openBagFav(_el, _class);
      });

      _clickElClose.addEventListener('click', function () {
    ...
    key: "addListenersToModalBg",
    value: function addListenersToModalBg() {
    ...
    key: "openBagFav",
    value: function openBagFav(_el, _class) {
    ...
    key: "disableBtn",
    value: function disableBtn(_selector) {
      document.querySelector(_selector).disabled = true;
    }
  }, {
    key: "enableBtn",
    value: function enableBtn(_selector) {
      document.querySelector(_selector).disabled = false;
    }
  }, {
    key: "setStyle",
    value: function setStyle(_ref) {
      var _footerEl = _ref._footerEl,
          _noItemsTitleEl = _ref._noItemsTitleEl,
          _displayFooter = _ref._displayFooter,
          _displayNoItemsTitle = _ref._displayNoItemsTitle;
      _footerEl.style.display = _displayFooter;
      _noItemsTitleEl.style.display = _displayNoItemsTitle;
    }
  }, {
    key: "setBagFavStyleEmpty",
    value: function setBagFavStyleEmpty(_footerEl, _noItemsTitleEl) {
      // if (this.arrBag.length <= 0) {
      this.setStyle({
        _footerEl: _footerEl,
        _noItemsTitleEl: _noItemsTitleEl,
        _displayFooter: 'none',
        _displayNoItemsTitle: 'block'
      }); // }
    }
  }, {
    key: "setBagFavStyleFilled",
    value: function setBagFavStyleFilled(_footerEl, _noItemsTitleEl) {
      this.setStyle({
        _footerEl: _footerEl,
        _noItemsTitleEl: _noItemsTitleEl,
        _displayFooter: 'grid',
...
exports.default = UI;
},{}],"scripts/classes/Products.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Products, [{
    ...
    value: function () {
      var _fetchProducts = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var apiKey, configObject, url, response, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                apiKey = "$2b$10$RIb7MpsCSbkaShHFKwvqB.I5kDrmuFGxSV12IG0NNdrt0MvWgEI5G";
                configObject = {
                  method: 'GET',
                ...
                url = "https://api.jsonbin.io/b/5e72239bb325b3162e39fe2d";
                _context.next = 6;
...
},{}],"scripts/classes/Storage.js":[function(require,module,exports) {
"use strict";
...
var Storage = /*#__PURE__*/function () {
  ...
  _createClass(Storage, null, [{
    key: "saveProducts",
    value: function saveProducts(all_products) {
    ...
    value: function getProduct(id) {
      ...
      var arrProducts = JSON.parse(localStorage.getItem('all_products'));
      return arrProducts.find(function (product) {
    ...
    key: "saveBag",
    value: function saveBag(arrBag) {
      localStorage.setItem('arrBag', JSON.stringify(arrBag));
    }
  }, {
    key: "saveFav",
    value: function saveFav(arrFav) {
...
},{}],"assets/products/002.png":[function(require,module,exports) {
module.exports = "/002.773d3600.png";
},{}],"assets/products/001.png":[function(require,module,exports) {
module.exports = "/001.2ebb18a9.png";
},{}],"assets/products/003.png":[function(require,module,exports) {
module.exports = "/003.ca45a8e1.png";
},{}],"assets/products/004.png":[function(require,module,exports) {
module.exports = "/004.0f5906f8.png";
},{}],"assets/products/005.png":[function(require,module,exports) {
module.exports = "/005.1ee27805.png";
},{}],"assets/products/006.png":[function(require,module,exports) {
module.exports = "/006.b5da1c8e.png";
},{}],"assets/products/007.png":[function(require,module,exports) {
module.exports = "/007.2b34d795.png";
},{}],"assets/products/008.png":[function(require,module,exports) {
module.exports = "/008.ffbecdf3.png";
},{}],"assets/products/009.png":[function(require,module,exports) {
module.exports = "/009.c357b140.png";
},{}],"assets/products/010.png":[function(require,module,exports) {
module.exports = "/010.f702d761.png";
},{}],"assets/products/011.png":[function(require,module,exports) {
module.exports = "/011.ae155f07.png";
},{}],"assets/products/012.png":[function(require,module,exports) {
module.exports = "/012.665061e3.png";
},{}],"assets/products/013.png":[function(require,module,exports) {
module.exports = "/013.7a3f0931.png";
},{}],"assets/products/014.png":[function(require,module,exports) {
module.exports = "/014.71cb21b3.png";
},{}],"assets/products/015.png":[function(require,module,exports) {
module.exports = "/015.7aa62432.png";
},{}],"assets/products/016.png":[function(require,module,exports) {
module.exports = "/016.608f3310.png";
},{}],"assets/products/017.png":[function(require,module,exports) {
module.exports = "/017.c78f6d3e.png";
},{}],"assets/products/018.png":[function(require,module,exports) {
module.exports = "/018.7a0b15e5.png";
},{}],"assets/products/019.png":[function(require,module,exports) {
module.exports = "/019.5d62d8c2.png";
},{}],"assets/products/020.png":[function(require,module,exports) {
module.exports = "/020.45a0f3c4.png";
},{}],"assets/products/021.png":[function(require,module,exports) {
module.exports = "/021.12dab49a.png";
},{}],"assets/products/022.png":[function(require,module,exports) {
module.exports = "/022.9dda34ef.png";
},{}],"assets/products/023.png":[function(require,module,exports) {
module.exports = "/023.b2a1d2e9.png";
},{}],"assets/products/024.png":[function(require,module,exports) {
module.exports = "/024.4b3f6d99.png";
},{}],"assets/products/025.png":[function(require,module,exports) {
module.exports = "/025.353b450b.png";
},{}],"assets/products/026.png":[function(require,module,exports) {
module.exports = "/026.4334d505.png";
},{}],"assets/products/027.png":[function(require,module,exports) {
module.exports = "/027.15cba651.png";
},{}],"assets/products/028.png":[function(require,module,exports) {
module.exports = "/028.f58a8de0.png";
},{}],"assets/products/029.png":[function(require,module,exports) {
module.exports = "/029.b4bb7feb.png";
},{}],"assets/products/030.png":[function(require,module,exports) {
module.exports = "/030.92426129.png";
},{}],"assets/products/031.png":[function(require,module,exports) {
module.exports = "/031.e23e3e21.png";
},{}],"assets/products/032.png":[function(require,module,exports) {
module.exports = "/032.94146214.png";
},{}],"assets/products/033.png":[function(require,module,exports) {
module.exports = "/033.89f425d6.png";
},{}],"assets/products/034.png":[function(require,module,exports) {
module.exports = "/034.6c6852ec.png";
},{}],"assets/products/035.png":[function(require,module,exports) {
module.exports = "/035.fb615e7b.png";
},{}],"assets/products/036.png":[function(require,module,exports) {
module.exports = "/036.c7f5f3b1.png";
},{}],"assets/products/037.png":[function(require,module,exports) {
module.exports = "/037.1b4a6d3d.png";
},{}],"assets/products/038.png":[function(require,module,exports) {
module.exports = "/038.7b085b53.png";
},{}],"assets/products/039.png":[function(require,module,exports) {
module.exports = "/039.5d01d579.png";
},{}],"assets/products/*.png":[function(require,module,exports) {
module.exports = {
  "002": require("./002.png"),
  "001": require("./001.png"),
  "003": require("./003.png"),
  ...
  _createClass(Filter, [{
    ...
    value: function changeTitle(title) {
      if ($title) {
        ...
        if (!$title.classList.contains('title--anim')) $title.classList.add('title--anim');else $title.classList.remove('title--anim');
...
var $noItemsTitle = document.querySelector('.bag--if-no-items');
...
var Bag = /*#__PURE__*/function () {
  ...
  _createClass(Bag, [{
    ...
    value: function addToBag(bagItem) {
      ...
      _UI.default.displayNoneTitleNoItems('.bag--if-no-items');

      _UI.default.enableBtn('.btn-checkout');

      _UI.default.enableBtn('.btn-clearbag'); // UI.setBagFavStyleFilled($bagFooter, $noItemsTitle);
    ...
    value: function clearBag() {
      ...
      _UI.default.disableBtn('.btn-checkout');

      _UI.default.disableBtn('.btn-clearbag'); // UI.setBagFavStyleEmpty($bagFooter, $noItemsTitle);
...
var $noItemsTitle = document.querySelector('.fav--if-no-items');
...
var Favourites = /*#__PURE__*/function (_Bag) {
  _inherits(Favourites, _Bag);
  ...
  function Favourites() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Favourites).call(this));
    _this._arrFav = [];
    return _this;
  }
  ...
  _createClass(Favourites, [{
    ...
    // arrFav = [];
    // arrFavBtns = [];
    value: function getFavBtns() {
      var _this2 = this;

      var $favBtns = _toConsumableArray(document.querySelectorAll('.card-fav-btn'));

      arrFavBtns = $favBtns;
      arrFavBtns.forEach(function (fav) {
        var itemID = fav.dataset.id;

        var itemInFav = _this2.arrFav.find(function (item) {
          return item.id == itemID;
        });
        ...
        fav.addEventListener('click', function () {
          if (!fav.classList.contains('card-fav-btn--liked')) {
            ...
            var favItem = _objectSpread({}, _Storage.default.getProduct(itemID), {
              amount: 1
            });

            _this2.arrFav = [].concat(_toConsumableArray(_this2.arrFav), [favItem]);

            _Storage.default.saveFav(_this2.arrFav);

            _this2.setFavValues(_this2.arrFav);
            ...
            _this2.deleteFromFavourites(itemID);

            document.querySelectorAll('.fav .item').forEach(function (item) {
    ...
    key: "getSingleFavBtn",
    value: function getSingleFavBtn(itemID) {
      return arrFavBtns.find(function (fav) {
        return fav.dataset.id == itemID;
      });
    }
  }, {
    key: "setFavValues",
    value: function setFavValues(_arrFav) {
      var items_counter = 0;
    ...
    key: "addToFavourites",
    value: function addToFavourites(favItem) {
      var arr_obj_imgs = _Filter.default.arrObjImgs;
      var article = document.createElement('article');
      article.classList.add('item');
      ...
      _UI.default.displayNoneTitleNoItems('.fav--if-no-items');

      _UI.default.enableBtn('.btn-clearfav'); // UI.setBagFavStyleFilled($favFooter, $noItemsTitle);

    }
  }, {
    key: "deleteFromFavourites",
    value: function deleteFromFavourites(itemID) {
      this.arrFav = this.arrFav.filter(function (item) {
        return item.id != itemID;
      });
    ...
    key: "removeLikedClass",
    value: function removeLikedClass(favBtn) {
      favBtn.classList.remove('card-fav-btn--liked');
    }
  }, {
    key: "addLikedClass",
    value: function addLikedClass(favBtn) {
      favBtn.classList.add('card-fav-btn--liked');
    }
  }, {
    key: "clearFav",
    value: function clearFav() {
      var _this3 = this;

      var favItemsIDs = this.arrFav.map(function (item) {
        return item.id;
      });
      favItemsIDs.forEach(function (itemID) {
        return _this3.deleteFromFavourites(itemID);
      });
      ...
      _UI.default.disableBtn('.btn-clearbag'); // UI.setBagFavStyleEmpty($favFooter, $noItemsTitle);
    ...
    key: "populateFav",
    value: function populateFav(_arrFav) {
      var _this4 = this;

      _arrFav.forEach(function (item) {
        return _this4.addToFavourites(item);
      });
    }
  }, {
    key: "favLogic",
    value: function favLogic() {
      var _this5 = this;

      $clearFavBtn.addEventListener('click', function () {
        _this5.clearFav();
      });
      $favItems.addEventListener('click', function (e) {
        if (e.target.closest('.item__icon--remove-from-fav')) {
          ...
          var $addItemToBagBtn = e.target;
          var _itemID = $addItemToBagBtn.dataset.id;

          var forBagItem = _objectSpread({}, _Storage.default.getProduct(_itemID), {
            amount: 1
          });

          var arr_bag = _Storage.default.getBag();

          var isAlreadyInBag = arr_bag.find(function (item) {
            return item.id == forBagItem.id;
          });

          if (!isAlreadyInBag) {
            $addItemToBagBtn.parentElement.classList.add('item--deleted');
            arr_bag = [].concat(_toConsumableArray(arr_bag), [forBagItem]);

            _set(_getPrototypeOf(Favourites.prototype), "arrBag", arr_bag, _this5, true);
            ...
            _this5.arrFav = _this5.arrFav.filter(function (item) {
              return item.id != _itemID;
            });
            ...
            console.table(_get(_getPrototypeOf(Favourites.prototype), "arrBag", _this5));
            $addItemToBagBtn.parentElement.classList.add('item--deleted');
            ...
            if (window.location.pathname == '/allwatches.html') {
              ...
              if (cardAddToBagBtn.dataset.id == _itemID) {
            ...
            alert("".concat(forBagItem.title, " watch is already in Bag! You can only remove this item from the Favourites."));
            return;
          }
        }
      });
...
var _Products = _interopRequireDefault(require("./classes/Products"));

var _Storage = _interopRequireDefault(require("./classes/Storage"));

var _Bag = _interopRequireDefault(require("./classes/Bag"));
