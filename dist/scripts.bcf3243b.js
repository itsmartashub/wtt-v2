...
window.onload = function () {
  document.querySelector('.navbar__bag').addEventListener('click', function () {
    document.querySelector('.bag').classList.add('bag--open'); // if(document.querySelector('.fav').classList.contains('fav--open')) {
    // 	document.querySelector('.fav').classList.remove('fav--open');
    // }
  });
  document.querySelector('.bag .btn-close').addEventListener('click', function () {
    document.querySelector('.bag').classList.remove('bag--open');
  });
  document.querySelector('.navbar__favs').addEventListener('click', function () {
    document.querySelector('.fav').classList.add('fav--open'); // if(document.querySelector('.bag').classList.contains('bag--open')) {
    // 	document.querySelector('.bag').classList.remove('bag--open');
    // }
  });
  document.querySelector('.fav .btn-close').addEventListener('click', function () {
    document.querySelector('.fav').classList.remove('fav--open');
  });
